...
主控腳本：
  ...
  2) 來源資料夾檢查
  3) 依序執行 stage0 → stage1 → stage2 → stage3
"""
...
from faceswap.stage0 import run_stage0
...
def parse_args():
    ...
    ap.add_argument("--just", choices=["all", "stage0", "stage1", "stage2", "stage3"], default="all", help="只執行某一階段或全部")
